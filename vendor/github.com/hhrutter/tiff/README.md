...
Working on [pdfcpu](https://github.com/sundonghui/pdfcpu) (a PDF processor) created a need for processing TIFF files and LZW compression in details beyond the standard library.
