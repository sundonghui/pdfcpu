...
[![Open in Visual Studio Code](https://img.shields.io/static/v1?logo=visualstudiocode&label=&message=Open%20in%20Visual%20Studio%20Code&labelColor=2c2c32&color=007acc&logoColor=007acc)](https://open.vscode.dev/sundonghui/pdfcpu)
[![Test](https://github.com/sundonghui/pdfcpu/workflows/Test/badge.svg)](https://github.com/sundonghui/pdfcpu/actions)
[![Coverage Status](https://coveralls.io/repos/github/sundonghui/pdfcpu/badge.svg?branch=master)](https://coveralls.io/github/sundonghui/pdfcpu?branch=master)
[![GoDoc](https://godoc.org/github.com/sundonghui/pdfcpu?status.svg)](https://pkg.go.dev/github.com/sundonghui/pdfcpu)
[![Go Report Card](https://goreportcard.com/badge/github.com/sundonghui/pdfcpu)](https://goreportcard.com/report/github.com/sundonghui/pdfcpu)
[![Hex.pm](https://img.shields.io/hexpm/l/plug.svg)](https://opensource.org/licenses/Apache-2.0)
[![Latest release](https://img.shields.io/github/release/sundonghui/pdfcpu.svg)](https://github.com/sundonghui/pdfcpu/releases)
...
* For API examples of all pdfcpu operations please refer to [GoDoc](https://pkg.go.dev/github.com/sundonghui/pdfcpu/pkg/api).

### GoDoc

* [pdfcpu package](https://pkg.go.dev/github.com/sundonghui/pdfcpu)
* [pdfcpu API](https://pkg.go.dev/github.com/sundonghui/pdfcpu/pkg/api)
* [pdfcpu CLI](https://pkg.go.dev/github.com/sundonghui/pdfcpu/pkg/cli)
...
### Download
Get the latest binary [here](https://github.com/sundonghui/pdfcpu/releases).


### Using Go Modules

```
$ git clone https://github.com/sundonghui/pdfcpu
...
```
$ go install github.com/sundonghui/pdfcpu/cmd/pdfcpu@latest
```
...
* Please [create](https://github.com/sundonghui/pdfcpu/issues/new/choose) an issue if you find a bug or want to propose a change.
* Feature requests - always welcome!
* Bug fixes - always welcome!
* PRs - let's [discuss](https://github.com/sundonghui/pdfcpu/discussions) first or [create](https://github.com/sundonghui/pdfcpu/issues/new/choose) an issue.
* pdfcpu is stable but still *Alpha* and occasionally undergoing heavy changes.

### How

* The pdfcpu [discussion board](https://github.com/sundonghui/pdfcpu/discussions) is open! Please engage in any form helpful for the community.
